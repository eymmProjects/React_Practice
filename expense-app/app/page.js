...
import { IncomeExpense, IncomeExpension } from "./_components/IncomeExpense";
      ...
      <div className="relative isolate overflow-hidden pt-14">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="text-center">
            ...
            <div className="flex gap-x-2 mx-auto text-center items-center flex-col">
              <IncomeExpense />
              <AddTransaction />
            </div>
            <p className="mt-6 text-lg leading-8 text-gray-300">History</p>
            <TransactionList />
          </div>
        </div>
        <div
